...
| [evidence-over-deference](skills/evidence-over-deference/SKILL.md) | The human's request rests on a premise you can check, or contradicts evidence or a recorded principle — verify first, challenge once with the evidence and an alternative, then execute their decision fully once heard. |
