...
`spec-driven-development` · `hexagonal-with-enforced-contracts` · `configuration-single-source-of-truth` · `surgical-changes-with-checkpoints` · `additive-default-off-feature-flags` · `battle-testing-on-real-infra` · `grounded-verifiable-gates` · `honest-reframing-over-overclaiming` · `reversible-by-default-confirm-consequential` · `structural-security-boundary` · `secrets-and-teardown-discipline` · `docs-as-deliverable` · `decision-memory` · `autonomous-self-improvement-loop-safety`
